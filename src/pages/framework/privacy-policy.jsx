    ...
    <div>
      ...
      {language === 'zh' ? (
        <div className="bg-white rounded-lg shadow-md p-8 overflow-y-scroll h-screen">
          ...
          <p className="mb-4">
            FGA科技团队（以下简称“我们”、“我们的”或“我们”）致力于保护您的隐私。本隐私政策解释了当您使用我们的技术产品和服务（“服务”）时，我们如何收集、使用、披露和保护您的信息。
          </p>
          ...
          <ul className="list-disc pl-8 mb-4">
            <li>
              <strong>个人数据</strong>
              ：当您注册服务或选择参与与服务相关的各种活动时，您自愿向我们提供的个人身份信息，例如您的姓名、邮寄地址、电子邮件地址和电话号码，以及您的年龄、性别、家乡和兴趣等人口统计信息。
            </li>
            <li>
              <strong>衍生数据</strong>
              ：当您访问服务时，我们的服务器自动收集的信息，例如您的IP地址、浏览器类型、操作系统、访问时间以及您在访问服务之前和之后直接查看的页面。
            </li>
          </ul>
          ...
          <p className="mb-4">
            我们不会将您的信息与第三方分享，用于托管服务、客户服务或营销工作。我们可能在以下情况下分享您的信息：
          </p>
          <ul className="list-disc pl-8 mb-4">
          ...
          <p className="mb-4">
            我们采用行政、技术和物理安全措施来帮助保护您的个人信息。尽管我们已经采取了合理的措施来保护您提供给我们的个人信息，但请注意，尽管我们已经努力，但没有安全措施是完美的或无法渗透的，也没有数据传输方法可以保证不会被任何拦截或其他类型的滥用。
          </p>
          ...
          <p className="mb-4">
            我们可能会不时更新我们的隐私政策。我们将通过在此页面上发布新的隐私政策来通知您任何更改。建议您定期查看本隐私政策以获取任何更改。本隐私政策的更改在发布在此页面时生效。
          </p>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 overflow-y-scroll h-screen">
          ...
          <p className="mb-4">
            FGA Tech Team ("we," "our," or "us") is committed to protecting your privacy. This
            Privacy Policy explains how we collect, use, disclose, and safeguard your information
            when you use our technology products and services ("Services").
          </p>
          ...
          <ul className="list-disc pl-8 mb-4">
            <li>
              ...
              information, such as your age, gender, hometown, and interests, that you voluntarily
              give to us when you register with the Services or when you choose to participate in
            ...
            <li>
              ...
              you access the Services, such as your IP address, your browser type, your operating
          ...
          <ul className="list-disc pl-8 mb-4">
            ...
            <li>
              To communicate with you, including for customer service, to provide you with updates
              and other information relating to the Services.
            </li>
          ...
          <p className="mb-4">
            We do not share your information with third parties for hosting services, customer
            service, or marketing efforts. We may share your information in the following
            situations:
          </p>
          <ul className="list-disc pl-8 mb-4">
            <li>
              To comply with legal obligations, including responding to subpoenas, court orders, and
